...
- **Adaptive Transport Pacer & Resilience**: Enterprise-grade backoff engines handle TCP aborts, vanished files, and rate limits dynamically without aborting sync jobs. Transient errors are absorbed smoothly.
